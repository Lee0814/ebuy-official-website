  ...
  return (
    <footer>
      ...
      <div className="relative">
        <div className="absolute -top-[120px] max-w-[1220px] bg-white px-6 py-16">
          <div className="text-[50px] font-bold">Get in touch with us</div>
          <div className="pb-14 pt-3 text-[28px] ">
            if you have any questions and requests, please feel free to call
            9774 5658 or fill in the form below
          </div>
      ...
      {/* end 表单 */}
      {/* start 链接 */}
      <div className="mx-auto box-border max-w-[1220px] pt-[56px]">
        <div className="container mx-auto flex justify-between bg-[#1d1f21] pt-14 text-[14px] text-[#acacac]">
          <ul>
        ...
        <div className="flex items-center justify-center pb-9 pt-24 text-[#acacac]">
